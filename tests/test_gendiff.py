...
def test_generate_diff():
    ...
    result_true = open("tests/fixtures/result_true.txt").read()
    ...
    assert diff_json == result_true
    assert diff_yaml == result_true
    assert diff_yml == result_true
...
def test_generate_diff8():
    result_true_json = open("tests/fixtures/result_true_json8.json").read()
